...
Also reveals which pilot (human supervisor) is associated with this key.`,
    {},
    async () => {
  ...
  server.tool(
    'pilot_token_create',
    `Generate a one-time login token for the human pilot.
...
The human gets an 8-hour dashboard session scoped to your workspace.`,
    {},
    async () => {
